												...
												<tr>	
														 <td data-column="Item"> <?php echo $row['title']; ?></td>
														  ...
														  <td data-column="Date"> <?php echo $row['date']; ?></td>
														   ...
														   <a href="track_order.php?order_id=<?php echo $row['o_id'];?>" class="btn btn-info btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-map-marker" style="font-size:16px"></i> Track</a>
															</td>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-4 address color-gray">
                                    ...
                                    <h5>Phone: 6364707151</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Addition informations</h5>
                                    <p>Made by Arun and Harsha</p>
                                    <p>Email : mitmysore@gmail.com<br> 
                                    Arun M C : 6364707151 <br> 
                                    Harsha : 9886363235<br> 
                                    </p>
                                </div>
                            </div>
                        </div>
