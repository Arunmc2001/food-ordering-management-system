...
(1, 'admin', '0192023a7bbd73250516f069df18b500', 'admin@mail.com', '', '2022-05-27 13:21:52');
...
-- Add Razorpay Order ID column to users_orders
ALTER TABLE users_orders ADD COLUMN razorpay_order_id VARCHAR(255);